import { CollectionReference, DocumentData, collection, doc, getDoc, getFirestore, setDoc } from "firebase/firestore";
...
const EditDeliveryAddress = () => {
  ...
  const {
    ...
    defaultValues: async () => {
      ...
      await presentLoading({ message: "Loading Address..." });
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonButtons slot="end">
            <IonButton id={`trigger-delete-address-${address?.id}`}>
